...
import { SetIsLoading, getUser, updatePhoto, updateUser } from '../../redux/features/auth/authSlice';
...
const Profile = () => {
  ...
  const savePhoto = async(e)=>{
    ...
    try {
      if(
        profilImage !== null &&
        (profilImage.type === "image/jpeg" || profilImage.type === "image/jpg" || profilImage.type === "image/png")
      ){
        const image = new FormData();
        image.append('file', profilImage)
      ...
      const userData = {
        photo: profilImage ? imageUrl : profile?.photo
      };
            ...
            {user && (
              <>
                <div className='profile-photo'>
                  <div>
                  <img src={!imagePreview ? user?.photo : imagePreview} alt="" />
